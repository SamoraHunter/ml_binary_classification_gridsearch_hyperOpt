...
class TestDataPipeline(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_data_path = (
            self.project_root / "notebooks" / "test_data_hfe_1yr_m_small_multiclass.csv"
        )
    ...
    def test_data_quality_in_final_data(self):
        ...
        self.assertEqual(
            np.isinf(pipeline.X_train.select_dtypes(include=np.number)).sum().sum(),
            0,
    ...
    def test_feature_importance_selection(self):
        ...
        features_before_importance = log[log["step"] == "Feature Importance"][
            "features_before"
        ].iloc[0]
