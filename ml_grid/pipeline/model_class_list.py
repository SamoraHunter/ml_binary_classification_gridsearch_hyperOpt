...
def get_model_class_list(ml_grid_object):
    ...
    if(model_class_dict == None and ml_grid_object.verbose >=1):
        ...
        model_class_dict = {
        "LogisticRegression_class": False,
        "knn_classifiers_class": False,
        "quadratic_discriminant_analysis_class": False,
        "SVC_class": False,
        "XGB_class_class": False,
        "mlp_classifier_class": False,
        "RandomForestClassifier_class": False,
        "GradientBoostingClassifier_class": False,
        "CatBoost_class": True,
        "GaussianNB_class": False,
        "LightGBMClassifierWrapper": False,
        "adaboost_class": False,
