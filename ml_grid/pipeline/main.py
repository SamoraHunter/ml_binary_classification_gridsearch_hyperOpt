...
from ml_grid.model_classes.NeuralNetworkClassifier_class import NeuralNetworkClassifier_class
...
#                          parameter_space_size=self.parameter_space_size),
            ...
            LightGBMClassifierWrapper(X=self.ml_grid_object.X_train, y=self.ml_grid_object.y_train,
                                     parameter_space_size=self.parameter_space_size),
...
#                     print(e)
        ...
        self.sub_sample_parameter_val = int(self.sub_sample_param_space_pct * self.mean_parameter_space_val)              
