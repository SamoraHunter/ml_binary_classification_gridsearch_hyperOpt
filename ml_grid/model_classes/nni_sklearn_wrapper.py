...
class NeuralNetworkClassifier(BaseEstimator, ClassifierMixin):
    def __init__(self, hidden_units_1=64, hidden_units_2=64, dropout_rate=0.3, learning_rate=0.001, activation_func='relu', epochs=10, batch_size=32):
    ...
    def build_model(self):
        model = Sequential()
        model.add(Dense(units=self.hidden_units_1, activation=self.activation_func, input_dim=self.X_train.shape[1]))
