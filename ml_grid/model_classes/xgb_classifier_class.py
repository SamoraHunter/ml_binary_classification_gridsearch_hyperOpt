    ...
    def __init__(
        ...
        def patch_max_bin(param_value: Any) -> Union[int, Real, Integer, Any]:
            ...
            if isinstance(param_value, int):
                ...
                return (
                    Real(2, param_value.high, prior=param_value.prior)
                    if isinstance(param_value, Real)
                    else Integer(2, param_value.high)
                )
            else:
                return param_value
        ...
        if global_parameters.bayessearch:
            ...
            self.parameter_space = {
                ...
                "gamma": Real(
                    1e-5, 1e-2, prior="log-uniform"
                ),  # Regularization parameter
                "grow_policy": Categorical(
                    ["depthwise", "lossguide"]
                ),  # Tree growth policy
                ...
                "sampling_method": Categorical(
                    ["uniform"]
                ),  # Sampling method during training
            ...
            self.parameter_space = {
                ...
                "gamma": self.parameter_vector_space.param_dict.get(
                    "log_small"
                ),  # Regularization parameter
                "grow_policy": ["depthwise", "lossguide"],  # Tree growth policy
                "learning_rate": self.parameter_vector_space.param_dict.get(
                    "log_small"
                ),  # Learning rate
                "max_bin": self.parameter_vector_space.param_dict.get(
                    "log_large_long"
                ),  # Max bins for discretization
                "max_depth": self.parameter_vector_space.param_dict.get(
                    "log_large_long"
                ),  # Max depth of tree
                "max_leaves": self.parameter_vector_space.param_dict.get(
                    "log_large_long"
                ...
                "reg_alpha": self.parameter_vector_space.param_dict.get(
                    "log_small"
                ),  # L1 regularization term
                "reg_lambda": self.parameter_vector_space.param_dict.get(
                    "log_small"
