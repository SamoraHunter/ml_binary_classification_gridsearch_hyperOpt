...
class LightGBMClassifier(BaseEstimator, ClassifierMixin):
    def __init__(self, boosting_type='gbdt', num_leaves=31, learning_rate=0.05, n_estimators=100, objective='multiclass', num_class=3, metric='multi_logloss', feature_fraction=0.9, early_stopping_rounds=None):
    ...
    def fit(self, X, y):
        self.model = lgb.LGBMClassifier(boosting_type=self.boosting_type,
