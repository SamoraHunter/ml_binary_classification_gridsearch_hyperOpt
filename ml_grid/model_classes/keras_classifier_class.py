...
class kerasClassifier_class:
    ...
    def __init__(self, X, y, parameter_space_size):
        ...
        def create_model(
            ...
            model.compile(
                loss="binary_crossentropy", optimizer=optimizer, metrics=[metric, "accuracy"]
            )
        ...
        self.algorithm_implementation = KerasClassifier(
            model=create_model, verbose=0, learning_rate=0.0001, layers=1, width=1, input_dim_val = self.x_train_col_val
        )
