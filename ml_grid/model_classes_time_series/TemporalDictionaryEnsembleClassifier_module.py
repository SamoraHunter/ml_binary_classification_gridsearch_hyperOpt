...
class TemporalDictionaryEnsemble_class:
    ...
    def __init__(self, ml_grid_object: pipe):
        ...
        if isinstance(time_limit_param, list):
            time_limit_param = time_limit_param[0]
        ...
        if ml_grid_object.global_params.bayessearch:
            self.parameter_space = {
                "n_parameter_samples": Categorical([100, 250, 500]),
                "max_ensemble_size": Categorical([25, 50, 100]),
                "max_win_len_prop": Real(0.5, 1.0),
                "min_window": Integer(5, 15),
                "randomly_selected_params": Categorical([25, 50, 75]),
                "bigrams": Categorical([True, False, None]),
                "dim_threshold": Real(0.7, 0.95),
                "max_dims": Integer(10, 30),
                "time_limit_in_minutes": time_limit_param,
                "contract_max_n_parameter_samples": Categorical([100, 250, 500]),
